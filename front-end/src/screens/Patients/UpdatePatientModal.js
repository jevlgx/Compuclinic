...
export const UpdatePatientOverviewModal = ({ isModalOpen=false, data }) => {
...
export const UpdatePatientContactsModal = ({ isModalOpen=false, data, contact }) => {
...
export const UpdatePatientBillsModal = ({ isModalOpen=false, data }) => {
